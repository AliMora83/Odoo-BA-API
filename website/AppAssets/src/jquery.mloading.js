...
;(function (root, factory) {
    ...
    if(!$){
        throw new TypeError("Jquery library must be started before it can be used normally ！");
    }
    ...
    MLoading.prototype={
        ...
        initElement:function () {
            ...
            if (textElement.length == 0) {
                textElement = $('<span class="mloading-text" style="color:#000!important"></span>');
    ...
    MLoading.defaultOptions = {
        ...
        html:false,
        content: "",//After setting content, the text and icon settings will be invalid 
        mask: true//Whether to show the mask (translucent background) 
    };
